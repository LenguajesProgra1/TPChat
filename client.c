...
error("ERROR de apertura de socket"); server = gethostbyname(argv[1]);
...
if (connect(sockfd,(struct sockaddr *)&serv_addr,sizeof(serv_addr)) < 0) error("ERROR de conexión"); printf("Por favor, introduzca el mensaje:");
